/*	Programming Assignment:	Dice Game
	Author:	Greg O'Marah
	U34240613
	Program Design, Tindell */
...
/* Fnct to Generate random number seed */
int get_seed()
{
	int seed=0;
	...
	/* The seed must be 1-30, and input verifcation + level0 verification */
